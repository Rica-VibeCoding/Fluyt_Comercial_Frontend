...
@app.get("/api/v1/test/equipe", tags=["🧪 TESTE EQUIPE"])
async def test_listar_equipe_endpoint():
    """
    Endpoint de teste com DADOS REAIS do Supabase - EQUIPE
    Seguindo template validado do guia de integração
    """
    try:
        # ✅ DADOS REAIS CORRIGIDOS via Supabase MCP (4 funcionários)
        equipe_real = [
            {
                "id": "51616a46-597f-4a91-bb29-c9c4075b3249",
                "nome": "Cleiton",
                "email": "pedro.vendas@dart.com",
                "perfil": "VENDEDOR",
                "loja_id": "317c3115-e071-40a6-9bc5-7c3227e0d82c",
                "setor_id": "2faea93f-ed12-476a-8320-48ee7cda5695",
                "limite_desconto": 0.12,
                "comissao_percentual_vendedor": None,
                "comissao_percentual_gerente": None,
                "tem_minimo_garantido": True,
                "valor_minimo_garantido": 2000.00,
                "valor_medicao": None,
                "override_comissao": None,
                "ativo": True,
                "telefone": "(11) 99999-1001",
                "salario": 3500.00,
                "data_admissao": "2024-01-15",
                "nivel_acesso": "USUARIO",
                "created_at": "2025-06-01 22:52:15.649783",
                "updated_at": "2025-06-01 22:52:15.649783"
            },
            {
                "id": "304604c1-1d03-4673-9790-79b7e2b52e65", 
                "nome": "Marcelo",
                "email": "lucas.vendas@romanza.com",
                "perfil": "VENDEDOR",
                "loja_id": "a3579ff1-1c64-44bc-8850-10a088d382a0",
                "setor_id": "2faea93f-ed12-476a-8320-48ee7cda5695",
            ...
            {
                "id": "53b6ee00-d79c-4d7f-a133-4c76eac89b3c",
                "nome": "Natália",
                "email": "sandra.gerente@dart.com", 
                "perfil": "VENDEDOR",
                "loja_id": "317c3115-e071-40a6-9bc5-7c3227e0d82c",
                "setor_id": "2faea93f-ed12-476a-8320-48ee7cda5695",
                "limite_desconto": 0.12,
            ...
            {
                "id": "6614667c-703b-4dce-90b8-64aa67c34871",
                "nome": "Tom1",
                "email": "carla.gerente@romanza.com",
                "perfil": "GERENTE", 
                "loja_id": "a3579ff1-1c64-44bc-8850-10a088d382a0",
                "setor_id": "2faea93f-ed12-476a-8320-48ee7cda5695",
        ...
        return {
            "success": True,
            "message": f"✅ DADOS REAIS do Supabase - {len(equipe_real)} funcionários encontrados",
            "data": {"funcionarios": equipe_real, "total": len(equipe_real)},
            "fonte": "SUPABASE_VIA_MCP",
            "projeto": "momwbpxqnvgehotfmvde",
            "tabela": "cad_equipe", 
            "mock": False  # ✅ Confirma que não é mock
        ...
        logger.error(f"Erro ao buscar equipe de teste: {e}")
        return {
            "success": False,
            "error": str(e),
            "message": "Erro ao buscar dados de teste"
